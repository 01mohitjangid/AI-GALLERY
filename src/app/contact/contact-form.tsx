    ...
    <div className="container mx-auto py-10 px-4">
      <Card className="max-w-2xl mx-auto">
        <CardHeader className="space-y-1">
          <CardTitle className="text-2xl font-bold">Contact PromptAI Gallery</CardTitle>
          ...
          {isSubmitted ? (
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="space-y-2">
                ...
                <Select name="need" required onValueChange={(value) => setSelectedNeed(value)}>
                  <SelectTrigger>
                    <SelectValue placeholder="Select what you need" />
                  </SelectTrigger>
                  <SelectContent>
                    <SelectItem value="custom-prompt">Custom Prompt</SelectItem>
                    <SelectItem value="prompt-optimization">Prompt Optimization</SelectItem>
              ...
              {selectedNeed === "other" && (
                <div className="space-y-2">
                  ...
                  <Input id="otherNeed" name="otherNeed" placeholder="Please specify your needs..." required />
                </div>
              )}
              ...
              <input type="hidden" name="_subject" value="New contact from PromptAI Gallery" />
